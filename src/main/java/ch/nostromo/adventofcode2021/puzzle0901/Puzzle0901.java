package ch.nostromo.adventofcode2021.puzzle0901;
...
public class Puzzle0901 {
    ...
    public static void main(String... args) throws URISyntaxException, IOException {
        List<String> input = Files.readAllLines(Paths.get(Puzzle0901.class.getClassLoader().getResource("0901/input.txt").toURI()), Charset.defaultCharset());
